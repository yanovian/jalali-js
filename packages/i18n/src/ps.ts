...
export const ps: LocalePack = {
  ...
  ui: {
    ...
    previousYear: 'تېر کال',
    nextYear: 'راتلونکی کال',
    previousYears: 'مخکیني کلونه',
    nextYears: 'راتلونکي کلونه',
    previousWeek: 'تېره اونۍ',
    nextWeek: 'راتلونکې اونۍ',
    previousDay: 'تېره ورځ',
    nextDay: 'راتلونکې ورځ',
    chooseMonth: 'میاشت وټاکئ',
    chooseYear: 'کال وټاکئ',
    chooseDate: 'نېټه وټاکئ',
    chooseDateAndTime: 'نېټه او وخت وټاکئ',
    chooseDateRange: 'د نېټو واټن وټاکئ',
    month: 'میاشت',
    year: 'کال',
    day: 'ورځ',
    hour: 'ساعت',
