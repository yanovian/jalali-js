---
description: هسته یا یک رابط فریم‌ورک را نصب کنید، سپس تاریخ را تبدیل کنید یا یک انتخابگر بسازید.
---
...
هر رابط خودش به `@jalali-js/i18n` وابسته است، و انتخابگرها می‌توانند تعطیلات ایران را با
