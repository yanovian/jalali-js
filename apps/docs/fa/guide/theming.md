...
`Calendar` (React و Vue) پریمیتیو بدون ظاهر است: نشانه‌گذاری ساده با ویژگی‌های `data-jalali-*`
و بدون CSS اجباری، تا بتوانید ظاهر را کامل عوض کنید. `DatePicker` همان پریمیتیو با popover و
...
`@jalali-js/ui-react` (و `@jalali-js/ui-vue`) مؤلفه‌های بیشتری روی همان پریمیتیوهای بدون ظاهر
اضافه می‌کنند:
