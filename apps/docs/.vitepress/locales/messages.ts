...
export const messages = {
  ...
  fa: {
    ...
    dir: 'rtl',
    description:
      'کیت تقویم جلالی (هجری شمسی)، نوشته‌شده با TypeScript، به‌همراه پشتیبانی کامل از React و Vue.',
    nav: {
      guide: 'راهنما',
      api: 'API',
      npm: 'اکوسیستم npm',
      playground: 'نسخه زنده',
      playgroundReact: 'React',
      playgroundVue: 'Vue',
      playgroundVanilla: 'Vanilla / Web Components',
    },
    sidebar: {
      ...
      displayVsStorage: 'مقدار نمایشی در برابر مقدار ذخیره‌سازی',
      theming: 'پیکربندی و شخصی‌سازی ظاهر',
      ...
      browserSupport: 'پشتیبانی از مرورگر',
    ...
    search: {
      ...
      modalFooterNavigateText: 'برای پیمایش',
